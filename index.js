...
// ANSWER: No, because both the time and space complexity are at an O(1) level, so it's just a constant that will be the same every time.
...
// ANSWER: Both functions are linear because they get larger depending on how long the string that's called is, which could be variable.
